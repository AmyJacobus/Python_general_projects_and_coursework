...
def forage_samples_input():  # While loop to ask for forage samples taken
    while True:
...
def dry_clipping_input():  # Output instruction message to user
    print()
    print('*' * 100)
    print()
...
def animal_unit_month():  # While loop to take user input of AUM
    while True:
...
def stocking_rate_calculation(): # Calculate the stocking rate and print the stocking rate result for the user
    print('*' * 100)
...
def goodbye_msg(): # Goodbye message to user
    print()
